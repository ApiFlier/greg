...
<head>
    ...
    <meta name="description" content="Relaxing Stables in the middle of the city">
    <meta name="keywords" content="Cape Coral horseboarding, SouthEastern Florida horseboarding, horseboarding">
    <meta name="author" content="Charles Meeks">

    <title>American Cream Stables</title>
    ...
    <!-- Custom CSS -->
    <link href="css/stables.css?v=2" rel="stylesheet">
...
<body>
    ...
    <header class="business-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="tagline">Call us today, you won't regret it</h1>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                <h3>A peaceful resort for your horses</h3>

                <p class="intro">At American Cream Stables, we are focused on horse owners being able to relax in our friendly atmosphere.  The safety and well being of our horses is our prime focus. We have a variety of age, breeds, size, and gender. We have a relaxed group that get together occasionally. Activities include bonfires, obstacle courses, and other social gatherings.</p>

            </div>
            <div class="col-sm-4">
            
                <h3>Give Us A Call!</h3>
                <strong>We currently have limited spots available </strong>
                <address>  
                    16210 Saddlewood Ln<br>
                    Cape Coral, FL 33991<br>
                    <a href="https://maps.app.goo.gl/EK6LzzC1ioLZkk6P9" target="_blank">Get Directions</a><br>
                </address>
                <address>
                    <abbr title="Cell Phone">Cell phone:</abbr> <a href="tel:+12399804435">239-980-4435</a><br>
                </address>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
               <img class="img-responsive img-circle img-center" src="img/ridingPen1.jpg" alt="The Riding Pen">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <img class="img-circle img-responsive img-center" src="img/washingStall2.jpg" alt="A horse eating">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p class="text-center">American Cream Stables &copy; 2024 <br> 16210 Saddlewood Ln, Cape Coral, FL 33991</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
